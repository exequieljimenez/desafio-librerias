...
function mostrarMenuLista() {
    Swal.fire({
        ...
        text: "En esta sección podrá ver la lista completa de películas en el sitio",
...
function mostrarMenuBusqueda() {
    Swal.fire({
        title: "Búsqueda",
        text: "En esta sección podrá buscar películas por título, director o año",
        confirmButtonText: "De acuerdo",
        color: "#2b2b2b",
        confirmButtonColor: "#2b2b2b",
    })
...
function mostrarMenuFavoritas() {
    Swal.fire({
        title: "Favoritas",
        text: "En esta sección podrá ver las películas que fue seleccionando como favoritas",
        confirmButtonText: "De acuerdo",
        color: "#2b2b2b",
        confirmButtonColor: "#2b2b2b",
    })
